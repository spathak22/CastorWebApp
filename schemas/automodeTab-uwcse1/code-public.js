  ...
  style: cytoscape.stylesheet()
    ...
    .selector('#ta')
      .css({
        'height': 200,
        'width': 200,
        'background-image': 'http://josepicado.com/castor/icde18-demo/schemas/images/uwcse-schema/ta.png'
      })
    .selector('#publication')
      .css({
        'height': 160,
        'width': 200,
        'background-image': 'http://josepicado.com/castor/icde18-demo/schemas/images/uwcse-schema/publication.png'
      })
    .selector('#advisedby')
      .css({
        'height': 160,
        'width': 200,
        'background-image': 'http://josepicado.com/castor/icde18-demo/schemas/images/uwcse-schema/advisedby.png'
      }),
  elements: {
    nodes: [
